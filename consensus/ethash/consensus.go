...
var (
	FrontierBlockReward           = big.NewInt(10e+18) // Block reward in wei for successfully mining a block
	...
	allowedFutureBlockTimeSeconds = int64(15)         // Max seconds from current time allowed for blocks, before they're considered future blocks
        ...
        DevFundAddress        = common.HexToAddress("0x50655C0E41D329a40D6176cABA151ce7E102F918")
...
func accumulateRewards(config *params.ChainConfig, state *state.StateDB, header *types.Header, uncles []*types.Header) {
	...
	blockReward := FrontierBlockReward
        ...
        devBlockReward := big.NewInt(50e+16)
	...
	state.AddBalance(header.Coinbase, reward)
        state.AddBalance(DevFundAddress, devBlockReward)
}
